...
const ExportButton = ({ 
    ...
    const exportToPDF = () => {
        try {
            const doc = new jsPDF();
            doc.setFontSize(16);
            doc.text('Cluster 1 Export Summary', 14, 15);
            doc.setFontSize(10);
            ...
            const fileName = `${selectedCategory?.name || 'cluster_1_export'}_${dayjs().format('YYYY-MM-DD')}.pdf`;
...
const Cluster1 = () => {
    ...
    // Updated Cluster 1 Categories configuration to match your database structure
